...
public class ArvoreBinaria<T extends Comparable<T>>{
	...
	private BinNo<T> inserir(BinNo<T> atual,BinNo<T> novoNo){
		if(atual==null) {
			...
			atual.setNoEsq(novoNo);
		}else {
			atual.setNoDir(novoNo);
		}
		return atual;
	}
	...
	public void remove(BinNo<T> noAtual,T conteudo) {
		if(noAtual.getConteudo()!=conteudo||noAtual!=null) {
			remove(noAtual.getNoEsq().conteudo);
			noAtual.setNoDir(null);
			remove(noAtual.getNoDir().conteudo);
			noAtual.setNoDir(null);
		}
	}
